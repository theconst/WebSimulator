...
(function () {
    ...
    function Ca(a, c, b) {
        ...
        if (isNaN(e)) {
            try {
                ...
                Y.style.display = "";
                Y.setAttribute("style", a);
                e = Math.round(Y.offsetHeight);
    ...
    function K(a,
               c, b, d) {
        if (a.addEventListener) a.addEventListener(c, b, d || !1); else if (a.attachEvent) a.attachEvent("on" + c, function (d) {
            d = d || window.event;
    ...
    function la(a, c, b) {
        if (t && Fa) {
            ...
            ma = d.webkitBackingStorePixelRatio || d.mozBackingStorePixelRatio || d.msBackingStorePixelRatio || d.oBackingStorePixelRatio || d.backingStorePixelRatio || 1;
            O = ua / ma;
            a.width = c * O;
            a.height = b * O;
            ua !== ma && (a.style.width = c + "px", a.style.height = b + "px", d.scale(O, O))
    ...
    function Na(a) {
        // if (!Ga) {
        //     var c = !1, b = !1;
        //     "undefined" === typeof da.Chart.creditHref ? (a.creditHref = "http://canvasjs.com/", a.creditText = "CanvasJS.com") : (c = a.updateOption("creditText"),
        //         b = a.updateOption("creditHref"));
    ...
    function T(a, c, b) {
        c.getAttribute("state") !== b && (c.setAttribute("state", b), c.setAttribute("type",
            "button"), c.style.position = "relative", c.style.margin = "0px 0px 0px 0px", c.style.padding = "3px 4px 0px 4px", c.style.cssFloat = "left", c.setAttribute("title", a._cultureInfo[b + "Text"]), c.innerHTML = "<img style='height:16px;' src='" + Oa[b].image + "' alt='" + a._cultureInfo[b + "Text"] + "' />")
    }
    ...
    function z(a, c, b) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "", c = a = 0, a = this._options.width ? this.width : 0 < this._container.clientWidth ? this._container.clientWidth : this.width, c = this._options.height ? this.height : 0 < this._container.clientHeight ?
            ...
            d._mouseEventHandler(a)
        }), K(this.overlaidCanvas, window.navigator.msPointerEnabled ?
            ...
            d._touchEventHandler(a)
        }), this._toolTip = new U(this, this._options.toolTip, this.theme), this.axisY2 =
    ...
    function oa(a, c) {
        for (var b = [], d, e = 0; e < a.length; e++)if (0 == e) b.push(a[0]); else {
            ...
            var p = (a[g].x - a[f].x) / d;
            d = (a[g].y - a[f].y) / d;
            b[b.length] = a[h].x > a[f].x && 0 < p || a[h].x < a[f].x &&
            0 > p ? {x: a[h].x + p / 3, y: a[h].y + d / 3} : {x: a[h].x, y: a[h].y + d / 9};
            h = e;
            f = 0 === h ? 0 : h - 1;
            g = h === a.length - 1 ? h : h + 1;
    ...
    function Ia(a, c) {
        ...
        return !isNaN(b) && b <= c && 0 <=
        b ? b : c
    }

    function fa(a, c, b, d, e) {
    ...
    function M(a, c) {
        M.base.constructor.call(this, "TextBlock", c);
        this.ctx = a;
        this._isDirty = !0;
    ...
    function ia(a, c) {
        ia.base.constructor.call(this, "Title", c, a.theme);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
        if (x(this._options.margin) && a._options.subtitles)for (var b =
            a._options.subtitles, d = 0; d < b.length; d++)if ((x(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (x(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    function pa(a,
                c) {
        pa.base.constructor.call(this, "Subtitle", c, a.theme);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
        "undefined" === typeof this._options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
    ...
    function qa(a, c, b) {
        qa.base.constructor.call(this, "Legend", c, b);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function va(a, c) {
        va.base.constructor.call(this, c);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx
    }
    ...
    function X(a, c, b, d, e) {
        X.base.constructor.call(this, "DataSeries", c, b);
        this.chart = a;
        this.canvas = a.canvas;
    ...
    function B(a, c, b, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)for (this.stripLines = [], c = 0; c < this._options.stripLines.length; c++)this.stripLines.push(new ra(this.chart, this._options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    function ra(a, c, b, d, e) {
        ra.base.constructor.call(this, "StripLine", c, b, e);
        this.id = d;
        this.chart = a;
        this.ctx = this.chart.ctx;
        this.label = this.label;
        this._thicknessType = "pixel";
        null !== this.startValue && null !== this.endValue && (this.value = e.logarithmic ? Math.sqrt((this.startValue.getTime ? this.startValue.getTime() : this.startValue) * (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) : ((this.startValue.getTime ? this.startValue.getTime() : this.startValue) + (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) /
        2, this.thickness = e.logarithmic ? Math.log(this.endValue / this.startValue) / Math.log(e.logarithmBase) : Math.max(this.endValue - this.startValue), this._thicknessType = "value")
    }
    ...
    function ha(a) {
        ...
        this.ghostCanvas = ba(this.chart.width, this.chart.height);
    ...
    function ja(a) {
        var c;
        a && ka[a] && (c = ka[a]);
        ja.base.constructor.call(this, "CultureInfo", c)
    }
    ...
    var H = {}, t = !!document.createElement("canvas").getContext, da = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        ka = {en: {}}, ca = {
            ...
            theme1: {
                ...
                Legend: {
                    verticalAlign: "bottom",
                    horizontalAlign: "center", fontFamily: t ? "monospace, sans-serif,arial black" : "arial"
                },
                DataSeries: {
                    indexLabelFontColor: "grey",
                ...
                Subtitle: {
                    fontFamily: t ?
                        "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri",
                    fontSize: 16,
                    fontColor: "#3A3A3A",
                    fontWeight: "bold",
                    verticalAlign: "top",
            ...
            return function (h, p, k) {
                var n = k ? k.days : c, m = k ? k.months : d, l = k ? k.shortDays : b, q = k ? k.shortMonths : e;
                k = "";
                var r = !1;
                ...
                k = r ? "getUTC" : "get";
                var s = h[k + "Date"](), y = h[k + "Day"](), u = h[k + "Month"](), v = h[k + "FullYear"](), w = h[k + "Hours"](), t = h[k + "Minutes"](), V = h[k + "Seconds"](), A = h[k + "Milliseconds"](), x = r ? 0 : h.getTimezoneOffset();
                return k = p.replace(a, function (a) {
                    switch (a) {
                        ...
                        case "YY":
                            return Q(String(v).slice(-2), 2);
                        case "YYY":
                            return Q(String(v).slice(-3), 3);
                        case "YYYY":
                            return Q(v, 4);
                        case "h":
                            return w % 12 || 12;
                        ...
                        case "ff":
                            return Q(String(A).slice(0, 2), 2);
                        case "fff":
                            return Q(String(A).slice(0, 3), 3);
                        case "t":
                            return 12 > w ? "a" : "p";
                        case "tt":
                            return 12 > w ? "am" : "pm";
                        ...
                        case "zz":
                            return (0 < x ? "-" : "+") + Q(Math.floor(Math.abs(x) / 60), 2);
                        case "zzz":
                            return (0 < x ? "-" : "+") + Q(Math.floor(Math.abs(x) / 60), 2) + Q(Math.abs(x) %
                                    60, 2);
                        default:
            ...
            c = String(c);
            var g = 1, h = b = "", p = -1, k = [], n = [], m = 0, l = 0, q = 0, r = !1, s = 0, h = c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            c = null;
            for (var y = 0; h && y < h.length; y++)if (c = h[y], "." === c && 0 > p) p = y; else {
            ...
            a = (c[1] + "").split("");
            g && "0" === g[0] && g.shift();
            for (y = r = h = l = p = 0; 0 < k.length;)if (c = k.pop(), "#" === c || "0" === c)if (p++, p === m) {
                var u = g, g = [];
                if ("0" === c)for (c = m - l - (u ? u.length : 0); 0 < c;)u.unshift("0"), c--;
                for (; 0 <
                       u.length;)b = u.pop() + b, y++, 0 === y % r && (h === q && 0 < u.length) && (b = f + b);
                d && (b = "-" + b)
            } else 0 < g.length ? (b = g.pop() + b, l++, y++) : "0" === c && (b = "0" + b, l++, y++), 0 === y % r && (h === q && 0 < g.length) && (b = f + b); else"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (h++, r = y, y = 0, 0 < g.length && (b = f + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function (a) {
                return Q(s,
                    a.length)
            }));
            d = "";
            ...
            return {x: c, y: b}
        }, Fa = !0, ua = window.devicePixelRatio || 1, ma = 1, O = Fa ? ua / ma : 1, Ga = window && window.location && window.location.href && window.location.href.indexOf && -1 !== window.location.href.indexOf("canvasjs.com"), Oa = {
    ...
    (function () {
        ...
        H.pro = {sCH: da[H.fSDec([67, 104, 97, 114, 116])][H.fSDec([99, 114, 101, 100, 105, 116, 72, 114, 101, 102])]};
        H.fAWm = function (a) {
            if ("undefined" === typeof H.pro.sCH && !Ga) {
                var c = a[H.fSDec(H.str.ct)];
                c[H.fSDec(H.str.tBl)] = H.fSDec(H.str.tp);
                c[H.fSDec(H.str.fnt)] = 11 + H.fSDec(H.str.fntStr);
                c[H.fSDec(H.str.fSy)] = H.fSDec(H.str.gr);
                c[H.fSDec(H.str.fTx)](H.fSDec(H.str.tv), 2, a.height - 11 - 2)
            }
        }
    })();
    L.prototype.setOptions = function (a, c) {
        if (da[this._defaultsKey]) {
            var b = da[this._defaultsKey], d;
            for (d in b)b.hasOwnProperty(d) && (this[d] = a && d in a ? a[d] : c && d in c ? c[d] : b[d])
        }
    };
    L.prototype.updateOption = function (a) {
        var c = da[this._defaultsKey], b = this._options.theme ? this._options.theme : this.chart && this.chart._options.theme ? this.chart._options.theme : "theme1", d = {}, e = this[a];
        b && (ea[b] && ea[b][this._defaultsKey]) && (d = ea[b][this._defaultsKey]);
    ...
    L.prototype.dispatchEvent = function (a, c, b) {
        ...
        "function" === typeof this[a] && this[a].call(b || this.chart._publicChartReference,
            c)
    };
    S(z, L);
    z.prototype._updateOptions = function () {
        ...
        this.updateOption("colorSet") && (this._selectedColorSet = "undefined" !== typeof ca[this.colorSet] ? ca[this.colorSet] : ca.colorSet1);
        this.updateOption("backgroundColor");
        this.backgroundColor || (this.backgroundColor =
            "rgba(0,0,0,0)");
        this.updateOption("culture");
        this._cultureInfo = new ja(this._options.culture);
        ...
        this._options.zoomEnabled ? (this._zoomButton || (W(this._zoomButton = document.createElement("button")), T(this, this._zoomButton,
            "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function () {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, T(a, a._zoomButton, "pan"));
            a.render()
        })), this._resetButton || (W(this._resetButton = document.createElement("button")), T(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), K(this._resetButton, "click", function () {
            a._toolTip.hide();
            ...
            a.sessionVariables.axisY2 && (a.sessionVariables.axisY2.newViewportMinimum = null, a.sessionVariables.axisY2.newViewportMaximum =
                null);
            a.resetOverlayedCanvas();
            W(a._zoomButton, a._resetButton);
            ...
            this.zoomEnabled = !1;
        this._menuButton ? this.exportEnabled ? na(this._menuButton) : W(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"), T(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), K(this._menuButton, "click", function () {
        ...
        if (!this._dropdownMenu &&
            ...
            K(c, "click", function () {
                Ha(a.canvas, "png", a.exportFileName);
                W(a._dropdownMenu)
            }, !0)
        }
        ...
        for (var b in this._toolTip._options)this._toolTip._options.hasOwnProperty(b) && this._toolTip.updateOption(b)
    };
    z.prototype._updateSize = function () {
        ...
        return this.canvas.width !== a * O || this.canvas.height !== c * O ? (la(this.canvas, a, c), la(this.overlaidCanvas, a, c), la(this._eventManager.ghostCanvas, a, c), !0) : !1
    };
    z.prototype._initialize = function () {
        this._animator ? this._animator.cancelAllAnimations() : this._animator = new wa(this);
        ...
        this.layoutManager = new fa(0, 0, this.width, this.height,
            2);
        this.plotArea.layoutManager && this.plotArea.layoutManager.reset();
        this.data = [];
        var a = 0;
        if (this._options.data)for (var c = 0; c < this._options.data.length; c++)if (a++, !this._options.data[c].type || 0 <= z._supportedChartTypes.indexOf(this._options.data[c].type)) {
            var b = new X(this, this._options.data[c], this.theme, a - 1, ++this._eventManager.lastObjectId);
    ...
    z.prototype.render = function (a) {
        ...
        b ? na(this._zoomButton, this._resetButton) : (W(this._zoomButton, this._resetButton), this._options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
        this._processData();
        this._options.title && (this._title = new ia(this, this._options.title), this._title.dockInsidePlotArea ? c.push(this._title) : this._title.render());
        if (this._options.subtitles)for (a = 0; a < this._options.subtitles.length; a++)this.subtitles = [], b = new pa(this, this._options.subtitles[a]), this.subtitles.push(b),
            b.dockInsidePlotArea ? c.push(b) : b.render();
        this.legend = new qa(this, this._options.legend, this.theme);
        ...
        if (this.animatedRender) {
            var e = ba(this.width, this.height);
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)for (c = this.plotInfo.plotTypes[a], b = 0; b < c.plotUnits.length; b++) {
            ...
            f.targetCanvas = null;
            this.animatedRender && (f.targetCanvas = ba(this.width, this.height), f.targetCanvasCtx = f.targetCanvas.getContext("2d"));
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = ba(this.width, this.height).getContext("2d"), d.push(this.renderIndexLabels(a)));
        var p = this;
        0 < d.length ? (p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function (a) {
            p.ctx.clearRect(0, 0, p.width, p.height);
            p.ctx.drawImage(e, 0, 0, Math.floor(p.width * O), Math.floor(p.height * O), 0, 0, p.width, p.height);
            ...
            d = [];
            for (var a = 0; a < p.plotInfo.plotTypes.length; a++)for (var b = p.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++)b.plotUnits[c].targetCanvas =
                null;
            e = null;
            p.disableToolTip = !1
        })) : (0 < p._indexLabels.length && p.renderIndexLabels(), p.dispatchEvent("dataAnimationIterationEnd", {chart: p}));
        this.attachPlotAreaEventHandlers();
        this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || W(this._zoomButton, this._resetButton);
    ...
    z.prototype.categoriseDataSeries = function () {
        for (var a = "", c = 0; c < this.data.length; c++)if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
    ...
    z.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
            var h = this.data[a.dataSeriesIndexes[g]], p = 0, k = !1, n = !1, m;
            ...
            for (p = 0; p < h.dataPoints.length; p++) {
                ...
                if (d < l && !k) null !== e && (m = d); else {
                    if (!k && (k = !0, 0 < p)) {
                        p -= 2;
                        continue
                    }
                    if (d > q && !n) n = !0; else if (d > q && n)continue;
    ...
    z.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = this.data[a.dataSeriesIndexes[k]], m = 0, l = !1, q = !1, r;
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    if (d < s && !l) null !== n.dataPoints[m].y && (r = d); else {
                        if (!l && (l = !0, 0 < m)) {
                            m -= 2;
                            continue
                        }
                        if (d > y && !q) q = !0; else if (d > y && q)continue;
    ...
    z.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c =
            a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            var k = this.data[a.dataSeriesIndexes[p]], n = 0, m = !1, l = !1, q, r, s;
            ...
            for (n = 0; n < k.dataPoints.length; n++) {
                ...
                if (!(d < y) || m) {
                    ...
                    if (d > u && !l) l = !0; else if (d > u && l)continue;
                    k.dataPoints[n].label && (a.axisX.labels[d] = k.dataPoints[n].label);
                    d < b.viewPortMin && (b.viewPortMin = d);
                    d > b.viewPortMax && (b.viewPortMax = d);
                    if (b.viewPortMin === d && e)for (v = 0; v < e.length; v++)if (null === e[v] && q < d) {
                        b.viewPortMin = q;
                        break
                    }
    ...
    z.prototype.getDataPointAtXY = function (a, c, b) {
        ...
        a = null;
        c = !1;
        for (b = 0; b < d.length; b++)if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)if (e =
                R("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= e / 2) {
            c = !0;
            break
        }
    ...
    z.prototype.getObjectAtXY = function (a, c, b) {
        var d = null;
        if (b = this.getDataPointAtXY(a, c, b || !1)) d = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (t) d = Ea(a, c, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
            var e =
                this.legend.items[b];
    ...
    z.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < c.length; b++)e = c[b], f = document.createEvent("MouseEvent"),
    ...
    z.prototype._mouseEventHandler = function (a) {
        ...
        if (this.interactivityEnabled)if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), !e) {
            if (!z.capturedEventParam && this._events) {
                for (var f = 0; f < this._events.length; f++)if (this._events[f].hasOwnProperty(b))if (d =
    ...
    z.prototype._plotAreaMouseUp = function (a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) &&
            ...
            if ("xySwapped" === this.plotInfo.axisPlacement)var h = f, f = e, e = h;
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (e = f = 0; e < this._axes.length; e++)b = this._axes[e], b.logarithmic ? b.viewportMinimum < b.minimum ? (f = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * f, b.sessionVariables.newViewportMaximum =
                    ...
                    f, b.sessionVariables.newViewportMaximum = b.viewportMaximum - f, g = !0); else if ((!e || 2 < Math.abs(d)) && (!f || 2 < Math.abs(b)) && this.zoomEnabled) {
                ...
                g && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged",
                    "zoom"), g && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (na(this._zoomButton, this._resetButton), T(this, this._zoomButton, "pan"), T(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
    z.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled) e = {
                ...
                "pan"), this.render(), this._dispatchRangeEvent("rangeChanged", "pan"), this.dragStartPoint.x = a, this.dragStartPoint.y = c); else if (this.zoomEnabled) {
                this.resetOverlayedCanvas();
                b = this.overlaidCanvasCtx.globalAlpha;
                this.overlaidCanvasCtx.fillStyle = "#A89896";
                var d = e ? this.dragStartPoint.x : this.plotArea.x1, g = f ? this.dragStartPoint.y : this.plotArea.y1, h = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, p = f ? c - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
    ...
    z.prototype._zoomPanToSelectedRegion = function (a, c, b, d, e) {
        ...
        b = a.axesRanges;
        if (a.isValid)for (d = 0; d < c.length; d++)e = b[d], c[d].setViewPortRange(e.val1,
            e.val2);
        return a.isValid
    };
    z.prototype.validateRegion = function (a, c, b, d, e) {
        e = e || !1;
        var f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = !1, p = [], k = [], n = [];
        ...
        for (f = 0; f < k.length; f++) {
            ...
            if (m > l)var q = l, l = m, m = q;
            if (isFinite(g.dataInfo.minDiff))if (!(g.logarithmic && l / m < Math.pow(g.dataInfo.minDiff, 3) || !g.logarithmic &&
        ...
        return {isValid: h, axesWithValidRange: p, axesRanges: n}
    };
    ...
    z.prototype.renderIndexLabels = function (a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++) {
            var k = this._indexLabels[p], n = k.chartType.toLowerCase(), m, l, q = R("indexLabelFontColor",
                k.dataPoint, k.dataSeries), g = R("indexLabelFontSize", k.dataPoint, k.dataSeries), h = R("indexLabelFontFamily", k.dataPoint, k.dataSeries);
            m = R("indexLabelFontStyle", k.dataPoint, k.dataSeries);
            l = R("indexLabelFontWeight", k.dataPoint, k.dataSeries);
            var f = R("indexLabelBackgroundColor", k.dataPoint, k.dataSeries), d = R("indexLabelMaxWidth", k.dataPoint, k.dataSeries), e = R("indexLabelWrap", k.dataPoint, k.dataSeries), r = R("indexLabelLineDashType", k.dataPoint, k.dataSeries), s = R("indexLabelLineColor", k.dataPoint, k.dataSeries),
                y = x(k.dataPoint.indexLabelLineThickness) ? x(k.dataSeries._options.indexLabelLineThickness) ? 0 : k.dataSeries._options.indexLabelLineThickness : k.dataPoint.indexLabelLineThickness, b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, u = {
                    percent: null,
                    total: null
                }, v = null;
            ...
            if (null !== w && "" !== w) {
                var u = R("indexLabelPlacement", k.dataPoint, k.dataSeries), v = R("indexLabelOrientation", k.dataPoint, k.dataSeries), t = k.direction, V = k.dataSeries.axisX, A = k.dataSeries.axisY, z = !1, q = new M(a, {
                    x: 0,
                    y: 0,
                ...
                if (0 <=
                    ...
                    if (k.dataPoint.x < V.viewportMinimum || k.dataPoint.x > V.viewportMaximum || k.dataPoint.y < A.viewportMinimum || k.dataPoint.y > A.viewportMaximum)continue
                } else if (0 <= n.indexOf("column")) {
                    if (k.dataPoint.x < V.viewportMinimum || k.dataPoint.x > V.viewportMaximum || k.bounds.y1 > c.y2 || k.bounds.y2 < c.y1)continue
                } else if (0 <= n.indexOf("bar")) {
                    if (k.dataPoint.x < V.viewportMinimum || k.dataPoint.x > V.viewportMaximum || k.bounds.x1 > c.x2 || k.bounds.x2 <
                        c.x1)continue
                } else if (k.dataPoint.x < V.viewportMinimum || k.dataPoint.x > V.viewportMaximum)continue;
                d = f = 2;
                "horizontal" === v ? (g = q.width, h = q.height) : (h = q.width, g = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) u = "auto", f = 4; else if (0 <= n.indexOf("stacked")) "auto" === u && (u = "inside"); else if ("bubble" === n || "scatter" === n) u = "inside";
                    m = k.point.x - g / 2;
    ...
    z.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                var h = g.dataPoints, p = "solid";
                if (c.setLineDash) {
                    var k = D(g.nullDataLineDashType, g.lineThickness), p = g.lineDashType, n = D(p, g.lineThickness);
                    c.setLineDash(n)
                }
                var m = g.id;
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !u)))if ("number" !== typeof h[r].y) 0 < r && !(g.connectNullData || u || q) && (c.stroke(), t && b.stroke()), u = !0; else {
    ...
    z.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >=
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !u)))if ("number" !== typeof h[r].y) 0 < r && !(g.connectNullData || u || q) && (c.stroke(), t && b.stroke()), u = !0; else {
                        var v = y;
                        s = a.axisX.convertValueToPixel(s);
                        y = a.axisY.convertValueToPixel(h[r].y);
            ...
            t && b.beginPath();
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: F.xClipAnimation,
                easingFunction: F.easing.linear, animationBase: 0
            }
        }
    };
    z.prototype.renderSpline = function (a) {
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3)if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), t && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var l = h._colorSet, q = l = h._options.lineColor ?
                    h._options.lineColor : l[0];
                b.strokeStyle = l;
                var r = 0, s, y, u = [];
                b.beginPath();
                if (0 < p.length)for (y = !1, r = 0; r < p.length; r++)if (s = p[r].getTime ? p[r].x.getTime() : p[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))if ("number" !== typeof p[r].y) 0 < r && !y && (h.connectNullData ? b.setLineDash && (0 < u.length && (h._options.nullDataLineDashType || !p[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = n, k = h.nullDataLineDashType) : (c(u), u = [])), y = !0; else {
                    s = a.axisX.convertValueToPixel(s);
    ...
    var N = function (a, c, b, d, e, f, g, h, p, k, n, m, l) {
    ...
    z.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width /
                a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            n = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < l.length)for (var q = 5 < n && m.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++)if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin ||
                    h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                    ...
                    var r = a.axisX.reversed ? f - n << 0 : f + n << 0, s;
                    0 <= l[e].y ? s = p : (s = g, g = p);
                    g > s && (b = g, g = s, s = b);
                    b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                    N(c, f, g, r, s, b, 0, null, q && 0 <= l[e].y, 0 > l[e].y && q, !1, !1, m.fillOpacity);
                    b = m.dataPointIds[e];
                    ...
                    b = C(b);
                    t && N(this._eventManager.ghostCtx, f, g, r, s, b, 0, null, !1, !1, !1, !1);
                    (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "column",
                        dataPoint: l[e],
                        dataSeries: m,
                        point: {x: f + (r - f) / 2, y: 0 > l[e].y === a.axisY.reversed ? g : s},
    ...
    z.prototype.renderStackedColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = [], h = 0, p, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth :
                this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && h > n && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth &&
            (this.dataPointMinWidth && n < h) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            m < h && (m = h);
            m > n && (m = n);
            c.save();
            t && this._eventManager.ghostCtx.save();
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var l = a.dataSeriesIndexes[n], q = this.data[l], r = q.dataPoints;
                if (0 < r.length) {
                    var s = 5 < m && q.bevelEnabled ?
                        !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), y = d - a.plotType.plotUnits.length * m / 2 + a.index * m << 0, u = y + m << 0, v;
                        if (a.axisY.logarithmic) g[b] = r[h].y + (g[b] ? g[b] : 0), 0 < g[b] && (p = a.axisY.convertValueToPixel(g[b]), v = e[b] ? e[b] : k, e[b] = p); else if (p = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
                            var w = e[b] ? e[b] : 0;
                            p -= w;
                            v = k - w;
                            e[b] = w + (v - p)
                        } else w =
                            f[b] ? f[b] : 0, v = p + w, p = k + w, f[b] = w + (v - p);
                        b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                        N(c, y, p, u, v, b, 0, null, s && 0 <= r[h].y, 0 > r[h].y && s, !1, !1, q.fillOpacity);
                        b = q.dataPointIds[h];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
    ...
    z.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b =
                null, d = this.plotArea, e = [], f = [], g = [], h = 0, p, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) /
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var l = a.dataSeriesIndexes[n], q = this.data[l], r = q.dataPoints;
                if (0 < r.length)for (var s = 5 < m && q.bevelEnabled ? !0 : !1, h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                    d = a.axisX.convertValueToPixel(b);
                    p = 0 !== a.dataPointYSums[b] ? 100 * (r[h].y / a.dataPointYSums[b]) : 0;
                    var y = d - a.plotType.plotUnits.length * m / 2 + a.index * m << 0, u = y + m << 0, v;
                    ...
                    b = q.dataPointIds[h];
                    this._eventManager.objectMap[b] = {
                        id: b, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: h,
                        x1: y, y1: p, x2: u, y2: v
                    };
                    b = C(b);
                    t && N(this._eventManager.ghostCtx, y, p, u, v, b, 0, null, !1, !1, !1, !1);
            ...
            return {
                ...
                animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a
            }
        }
    };
    z.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 *
                this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ?
                            h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                        ...
                        var r = a.axisX.reversed ? g - n << 0 : g + n << 0, s;
                        0 <= l[e].y ? s = p : (s = f, f = p);
                        b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                        N(c, s, g, f, r, b, 0, null, q, !1, !1, !1, m.fillOpacity);
                        b = m.dataPointIds[e];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
                        ...
                        b = C(b);
                        t && N(this._eventManager.ghostCtx, s, g, f, r, b, 0, null, !1, !1, !1, !1);
                        (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "bar",
                            dataPoint: l[e],
                            dataSeries: m,
                            point: {x: 0 <= l[e].y ? f : s, y: g + (r - g) / 2},
                            direction: 0 > l[e].y === a.axisY.reversed ? 1 : -1,
    ...
    z.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = [], h = 0, p, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth :
                this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && h > n && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth &&
            (this.dataPointMinWidth && n < h) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            m < h && (m = h);
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < r.length) {
                    ...
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), y = d - a.plotType.plotUnits.length * m / 2 + a.index * m << 0, u = y + m << 0, v;
                        if (a.axisY.logarithmic) g[b] = r[h].y + (g[b] ? g[b] : 0), 0 < g[b] && (v = e[b] ? e[b] : k, e[b] = p = a.axisY.convertValueToPixel(g[b])); else if (p = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
                            var w = e[b] ? e[b] : 0;
                            v = k + w;
                            p += w;
                            e[b] = w + (p - v)
                        } else w =
                            f[b] ? f[b] : 0, v = p - w, p = k - w, f[b] = w + (p - v);
                        b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                        N(c, v, y, p, u, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                        b = q.dataPointIds[h];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
                        ...
                        b = C(b);
                        t && N(this._eventManager.ghostCtx, v, y, p, u, b, 0, null, !1, !1, !1, !1);
                        (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stackedBar",
                            dataPoint: r[h],
                            dataSeries: q,
                            point: {x: 0 <= r[h].y ? p : v, y: d},
                            direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: Math.min(v, p), y1: y, x2: Math.max(v, p), y2: u},
                            color: b
                        })
                    }
                }
    ...
    z.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea,
                e = [], f = [], g = [], h = 0, p, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) /
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < r.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        var d = a.axisX.convertValueToPixel(b), y;
                        y = 0 !== a.dataPointYSums[b] ? 100 * (r[h].y / a.dataPointYSums[b]) : 0;
                        var u = d - a.plotType.plotUnits.length * m / 2 + a.index * m << 0, v = u + m << 0;
                        if (a.axisY.logarithmic) {
                            g[b] =
                                y + (g[b] ? g[b] : 0);
                            if (0 >= g[b])continue;
                        ...
                        b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                        N(c, y, u, p, v, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                        b = q.dataPointIds[h];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
                        ...
                        b = C(b);
                        t && N(this._eventManager.ghostCtx,
                            y, u, p, v, b, 0, null, !1, !1, !1, !1);
                        (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stackedBar100",
                            dataPoint: r[h],
                            dataSeries: q,
                            point: {x: 0 <= r[h].y ? p : y, y: d},
                            direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: Math.min(y, p), y1: u, x2: Math.max(y, p), y2: v},
                            color: b
                        })
                    }
                }
    ...
    z.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var p = a.dataSeriesIndexes[h], k = this.data[p], n = k.dataPoints, g = k.id;
                this._eventManager.objectMap[g] = {objectType: "dataSeries", dataSeriesIndex: p};
                g = C(g);
                d.fillStyle = g;
                var g = [], m =
                    !0, l = 0, q, r, s, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, v = null;
                if (0 < n.length) {
                    var w = k._colorSet[l % k._colorSet.length], x = k._options.lineColor || w, z = x;
                    b.fillStyle = w;
                    b.strokeStyle = x;
                    b.lineWidth = k.lineThickness;
                    var A = "solid";
                    if (b.setLineDash) {
                        var B = D(k.nullDataLineDashType, k.lineThickness), A = k.lineDashType, J = D(A, k.lineThickness);
                        b.setLineDash(J)
                    }
                    for (var I = !0; l < n.length; l++)if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax &&
                        (!k.connectNullData || !I)))if ("number" !== typeof n[l].y) k.connectNullData || (I || m) || c(), I = !0; else {
    ...
    z.prototype.renderSplineArea = function (a) {
        function c() {
            ...
            if (0 < c.length) {
                if (0 < k.lineThickness) {
                    ...
                    for (var g = 0; g < c.length - 3; g += 3)if (b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), t && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle || c[g + 3].newLineDashArray) b.stroke(),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = 0, l, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s, y = null, u = [];
                if (0 < n.length) {
                    var v = k._colorSet[m % k._colorSet.length], w = k._options.lineColor || v,
                        x = w;
                    b.fillStyle = v;
                    b.strokeStyle = w;
                    b.lineWidth = k.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = D(k.nullDataLineDashType, k.lineThickness), z = k.lineDashType, B = D(z, k.lineThickness);
                        b.setLineDash(B)
                    }
                    for (q = !1; m < n.length; m++)if (l = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))if ("number" !== typeof n[m].y) 0 < m && !q && (k.connectNullData ? b.setLineDash && (0 < u.length && (k._options.nullDataLineDashType || !n[m - 1].lineDashType)) &&
                    (u[u.length - 1].newLineDashArray = A, z = k.nullDataLineDashType) : (c(), u = [])), q = !0; else {
                        ...
                        (n[m].indexLabel || k.indexLabel || n[m].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "splineArea", dataPoint: n[m], dataSeries: k, point: {x: l, y: q}, direction: 0 >
                            n[m].y === a.axisY.reversed ? 1 : -1, color: v
                        });
                        q = !1
                    }
                    c();
    ...
    z.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = !0, l = 0, q, r, s, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, v = null, w = !1;
                if (0 < n.length) {
                    var x = k._colorSet[l % k._colorSet.length], z = k._options.lineColor || x, A = z;
                    b.fillStyle = x;
                    b.strokeStyle = z;
                    b.lineWidth = k.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var J =
                            D(k.nullDataLineDashType, k.lineThickness), B = k.lineDashType, I = D(B, k.lineThickness);
                        b.setLineDash(I)
                    }
                    for (; l < n.length; l++)if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w))) {
                        var G = r;
    ...
    z.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = [], f = this.plotArea, g = [], h = [], p = [], k = [], n = 0, m, l, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx;
            t && s.beginPath();
            b.save();
            t && s.save();
            b.beginPath();
            ...
            for (var y =
                [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var u = a.dataSeriesIndexes[f], v = this.data[u], w = v.dataPoints;
                v.dataPointIndexes = [];
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                h = [];
                n = v.id;
                this._eventManager.objectMap[n] = {objectType: "dataSeries", dataSeriesIndex: u};
                n = C(n);
                s.fillStyle = n;
                if (0 < p.length) {
                    var d = v._colorSet[0], x = v._options.lineColor ||
                        d, z = x;
                    b.fillStyle = d;
                    b.strokeStyle = x;
                    ...
                    var A = "solid";
                    if (b.setLineDash) {
                        var B = D(v.nullDataLineDashType, v.lineThickness), A = v.lineDashType, J = D(A, v.lineThickness);
                        b.setLineDash(J)
                    }
                    for (var I = !0, n = 0; n < p.length; n++) {
                        q = p[n];
                        var G = null, G = 0 <= v.dataPointIndexes[q] ? w[v.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !I)))if ("number" !== typeof G.y) v.connectNullData || (I || y) || c(), I = !0; else {
                            ...
                            } else l = a.axisY.convertValueToPixel(G.y), l -= $;
                            h.push({x: m, y: r - $});
                            g[q] = r - l;
                            ...
                            if (0 <= v.dataPointIndexes[q]) {
                                var aa = v.dataPointIds[v.dataPointIndexes[q]];
                            ...
                            0 <= v.dataPointIndexes[q] && 0 !== G.markerSize && (0 < G.markerSize || 0 < v.markerSize) && (q = v.getMarkerProperties(n, m, l, b), e.push(q), markerColor = C(aa), t && e.push({
                                x: m,
                                y: l,
                                ctx: s,
                                type: q.type,
                            ...
                            (G.indexLabel || v.indexLabel || G.indexLabelFormatter || v.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stackedArea", dataPoint: G, dataSeries: v,
                                point: {x: m, y: l}, direction: 0 > w[n].y === a.axisY.reversed ? 1 : -1, color: d
                            })
                        }
                    }
                    c();
    ...
    z.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = this.plotArea, f = [], g = [], h = [], p = [], k = [], n = 0, m, l, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx;
            b.save();
            t && s.save();
            b.beginPath();
            ...
            for (var y = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                var u =
                    a.dataSeriesIndexes[e], v = this.data[u], w = v.dataPoints;
                v.dataPointIndexes = [];
                for (n = 0; n < w.length; n++)u = w[n].x.getTime ? w[n].x.getTime() : w[n].x, v.dataPointIndexes[u] = n, y[u] || (p.push(u), y[u] = !0);
                p.sort(ta)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                y = !0;
                d = v.id;
                this._eventManager.objectMap[d] = {objectType: "dataSeries", dataSeriesIndex: u};
                d = C(d);
                s.fillStyle = d;
                h = [];
                if (0 < p.length) {
                    var d = v._colorSet[n % v._colorSet.length], x = v._options.lineColor || d, z = x;
                    b.fillStyle =
                        d;
                    b.strokeStyle = x;
                    b.lineWidth = v.lineThickness;
                    ...
                    for (var I = !0, n = 0; n < p.length; n++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !I)))if ("number" !== typeof G.y) v.connectNullData || (I || y) || c(), I = !0; else {
                            ...
                            if (a.axisY.logarithmic) {
                                ...
                                if (0 >= k[q])continue;
                                l = a.axisY.convertValueToPixel(k[q])
                            } else l = a.axisY.convertValueToPixel($), l -= aa;
                            h.push({x: m, y: r - aa});
                            g[q] = r - l;
                            y || I ? (!y && v.connectNullData ? (b.setLineDash && (v._options.nullDataLineDashType || A === v.lineDashType && v.lineDashType !== v.nullDataLineDashType) && (b.stroke(), A = v.nullDataLineDashType, b.setLineDash(B)), b.lineTo(m, l), t && s.lineTo(m, l)) : (b.beginPath(), b.moveTo(m,
                                l), t && (s.beginPath(), s.moveTo(m, l))), I = y = !1) : (b.lineTo(m, l), t && s.lineTo(m, l), 0 == n % 250 && (c(), b.moveTo(m, l), t && s.moveTo(m, l), h.push({
                                x: m,
                                y: r - aa
                            })));
                            n < w.length - 1 && (z !== (w[n].lineColor || x) || A !== (w[n].lineDashType || v.lineDashType)) && (c(), b.beginPath(), b.moveTo(m, l), h.push({
                            ...
                            if (0 <= v.dataPointIndexes[q]) {
                                var ya = v.dataPointIds[v.dataPointIndexes[q]];
                                this._eventManager.objectMap[ya] = {
                                    id: ya,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: u,
                                    dataPointIndex: v.dataPointIndexes[q],
                            ...
                            0 <= v.dataPointIndexes[q] && 0 !== G.markerSize && (0 < G.markerSize || 0 < v.markerSize) && (q = v.getMarkerProperties(n, m, l, b), f.push(q), markerColor = C(ya), t && f.push({
                                x: m,
                                y: l,
                                ctx: s,
                                type: q.type,
    ...
    z.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var g = -Infinity, h = Infinity, p = 0; p < a.dataSeriesIndexes.length; p++)for (var k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints, l = 0, d = 0; d < m.length; d++)e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x, e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax || "undefined" === typeof m[d].z || (l = m[d].z, l >
            g && (g = l), l < h && (h = l));
            for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), p = 0; p < a.dataSeriesIndexes.length; p++)if (k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints, 0 < m.length)for (c.strokeStyle = "#4572A7 ", d = 0; d < m.length; d++)if (e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                e = a.axisX.convertValueToPixel(e);
                f = a.axisY.convertValueToPixel(m[d].y);
                var l = m[d].z, r = 2 * Math.max(Math.sqrt((g ===
                            h ? b / 2 : q + (b - q) / (g - h) * (l - h)) / Math.PI) << 0, 1), l = n.getMarkerProperties(d, c);
                l.size = r;
                c.globalAlpha = n.fillOpacity;
                P.drawMarker(e, f, c, l.type, l.size, l.color, l.borderColor, l.borderThickness);
                c.globalAlpha = 1;
                ...
                r = C(s);
                t && P.drawMarker(e, f, this._eventManager.ghostCtx, l.type, l.size, r, r, l.borderThickness);
                ...
                this._indexLabels.push({
                    ...
                    point: {x: e, y: f},
                    direction: 1,
                    bounds: {x1: e - l.size / 2, y1: f - l.size / 2, x2: e + l.size / 2, y2: f + l.size / 2},
                    color: null
                })
            }
            c.restore();
    ...
    z.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                var h = a.dataSeriesIndexes[g], p = this.data[h], k = p.dataPoints;
                if (0 < k.length) {
                    c.strokeStyle = "#4572A7 ";
                    Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
                    for (var n = 0, m = 0, d = 0; d < k.length; d++)if (e = k[d].getTime ? e = k[d].x.getTime() :
                        ...
                        P.drawMarker(l.x, l.y, l.ctx, l.type, l.size, l.color, l.borderColor, l.borderThickness);
                        c.globalAlpha = 1;
                        Math.sqrt((n - e) * (n - e) + (m - f) * (m - f)) < Math.min(l.size, 5) && k.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = p.dataPointIds[d], this._eventManager.objectMap[n] =
                            {
                                ...
                                x1: e,
                                y1: f
                            }, n = C(n), t && P.drawMarker(l.x, l.y, this._eventManager.ghostCtx, l.type, l.size, n, n, l.borderThickness), (k[d].indexLabel || p.indexLabel || k[d].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "scatter",
                            dataPoint: k[d],
                            dataSeries: p,
                            point: {x: e, y: f},
    ...
    z.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, e = 0, f, g, h, p, k, n, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            f = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.015 * this.width;
            var m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.7 * d.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) << 0;
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var q = a.dataSeriesIndexes[l], r = this.data[q], s = r.dataPoints;
                if (0 < s.length)for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? n = s[e].x.getTime() : n = s[e].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                    ...
                    var u = f - m / 2 << 0, v = u + m << 0, d = s[e].color ? s[e].color : r._colorSet[0], w = Math.round(Math.max(1, 0.15 * m)), x = 0 === w % 2 ? 0 : 0.5, z = r.dataPointIds[e];
                    ...
                    (s[e].indexLabel || r.indexLabel || s[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: s[e],
                        dataSeries: r,
                        point: {x: u + (v - u) / 2, y: a.axisY.reversed ? p : h},
                        direction: 1,
                        bounds: {x1: u, y1: Math.min(h, p), x2: v, y2: Math.max(h, p)},
                        color: d
                    })
                }
            }
    ...
    z.prototype.renderRangeColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth :
                1;
            ...
            h = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints;
                if (0 < m.length)for (var l = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e <
                m.length; e++)if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                    b = a.axisX.convertValueToPixel(g);
                    d = a.axisY.convertValueToPixel(m[e].y[0]);
                    f = a.axisY.convertValueToPixel(m[e].y[1]);
                    var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + p) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + p) * h << 0, r = a.axisX.reversed ?
                    q - h << 0 : q + h << 0, b = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
                    if (d > f) {
                        var s = d, d = f;
                        f = s
                    }
                    ...
                    N(c, q, d, r, f, b, 0, b, l, l, !1, !1, n.fillOpacity);
                    b = C(s);
                    t && N(this._eventManager.ghostCtx, q, d, r, f, b, 0, null, !1, !1, !1, !1);
                    if (m[e].indexLabel || n.indexLabel || m[e].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: m[e],
                        dataSeries: n,
                        indexKeyword: 0,
                        point: {x: q + (r - q) / 2, y: m[e].y[1] >= m[e].y[0] ? f : d},
                        ...
                        dataSeries: n,
                        indexKeyword: 1,
                        point: {x: q + (r - q) / 2, y: m[e].y[1] >= m[e].y[0] ? d : f},
                        direction: m[e].y[1] >= m[e].y[0] ? 1 : -1,
                        bounds: {x1: q, y1: Math.min(d, f), x2: r, y2: Math.max(d, f)},
                        color: b
                    })
            ...
            t && this._eventManager.ghostCtx.restore();
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation,
                easingFunction: F.easing.easeInQuad, animationBase: 0
            }
        }
    };
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) &&
                        ...
                        b = C(b);
                        t && N(this._eventManager.ghostCtx, d, g, f, r, b, 0, null, !1, !1, !1, !1);
    ...
    z.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                e = C(e);
                d.fillStyle = e;
                var e = [], n = !0, m = 0, l, q, r, s, y = null;
                if (0 < k.length) {
                    var u = p._colorSet[m % p._colorSet.length], v = p._options.lineColor || u, w = v;
                    b.fillStyle =
                        u;
                    b.strokeStyle = v;
                    ...
                    var x = "solid";
                    if (b.setLineDash) {
                        var z = D(p.nullDataLineDashType, p.lineThickness), x = p.lineDashType, A = D(x, p.lineThickness);
                        b.setLineDash(A)
                    }
                    for (var B = !0; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !B)))if (null !== k[m].y && k[m].y.length && "number" === typeof k[m].y[0] && "number" === typeof k[m].y[1]) {
                        ...
                        n || B ? (p.connectNullData && !n ? (b.setLineDash && (p._options.nullDataLineDashType || x === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = A, x = p.nullDataLineDashType, b.setLineDash(z)), b.lineTo(l, q), t && d.lineTo(l, q), g.push({
                            x: l,
                            y: r
                        })) : (b.beginPath(), b.moveTo(l, q), y = {x: l, y: q}, g = [], g.push({
                            x: l,
                            y: r
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                    ...
                    var e = [], k = 0, n, m, l,
                        q = [], r = [];
                    if (0 < p.length) {
                        var s = h._colorSet[k % h._colorSet.length], y = h._options.lineColor || s, u = y;
                        b.fillStyle = s;
                        b.lineWidth = h.lineThickness;
                        var v = "solid", w;
                        if (b.setLineDash) {
                            var x = D(h.nullDataLineDashType, h.lineThickness), v = h.lineDashType;
                            w = D(v, h.lineThickness)
                        }
                        for (m = !1; k < p.length; k++)if (n = p[k].x.getTime ? p[k].x.getTime() : p[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !m)))if (null !== p[k].y && p[k].y.length && "number" === typeof p[k].y[0] && "number" === typeof p[k].y[1]) {
                            n =
    ...
    var za = function (a, c, b, d, e, f, g, h, p) {
        if (!(0 > b)) {
    ...
    z.prototype.renderPie = function (a) {
        function c() {
            if (k && n) {
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    var f = n[e], g = k.dataPointIds[e], h = {
                        id: g,
                        objectType: "dataPoint",
                        dataPointIndex: e,
                        dataSeriesIndex: 0
                    ...
                    q.push(h);
                    var m = {percent: null, total: null}, r = null, m =
                    ...
                    h.indexLabelTextBlock = new M(p.plotArea.ctx, {
        ...
        function b(a) {
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    var e = 0.07 * A * Math.cos(q[b].midAngle), f = 0.07 * A * Math.sin(q[b].midAngle), g = !1;
                    if (n[b].exploded) {
                    ...
                    za(p.plotArea.ctx, q[b].center, q[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, q[b].percentInnerRadius)
                }
            }
            a = p.plotArea.ctx;
            a.save();
        ...
        function e(a) {
            for (var b = null, c = 1; c < n.length; c++)if (b = (a + c + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                b = null;
                break
            } else if (q[b].indexLabelText && b !== a && (0 > d(q[b], q[a]) || ("right" === q[a].hemisphere ? q[b].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y : q[b].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                h = null;
                for (l = 1; l < n.length; l++)if (h = (a - l + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
                    h = null;
                    break
                } else if (q[h].indexLabelText && q[h].hemisphere ===
                    q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) || ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))break; else h = null;
                p = h;
                m = e(a);
                l = h = 0;
        ...
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                    ...
                    for (var u, t, a = 0; a < n.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            if (0 > z) {
                                ...
                                t = z / (t + C || 1) * C;
                                var C = -1 * (z - t), E = D = 0;
                                "right" === h.hemisphere ? (D = f(a, t), C = -1 * (z - D), E = f(x, C), +E.toFixed(v) < +C.toFixed(v) && +D.toFixed(v) <= +t.toFixed(v) && f(a, -(C - E))) : (D = f(x, t), C = -1 * (z - D), E = f(a, C), +E.toFixed(v) < +C.toFixed(v) && +D.toFixed(v) <= +t.toFixed(v) && f(x, -(C - E)))
                            }
                        }
                    }
                } else for (a = 0; a < n.length; a++)h = q[a], s = "pie" === k.type ? 0.7 * A : 0.8 * A, x = w.x + s * Math.cos(h.midAngle), t = w.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = t;
                for (a = 0; a < n.length; a++)if (h = q[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width) x = x = 0, "right" === h.hemisphere ? (x = l.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width +
                ...
                (function () {
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < n.length; g++)if (f = !1, u = q[g], u.indexLabelText) {
                        var h = e(g);
                        if (null !== h) {
                            var k = q[h];
                            z = 0;
                            ...
                            if (l = 0 > z) {
                                ...
                                var p = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height /
                                    2, r = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height / 2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, v = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, t = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
                            ...
                            f && (0 < c && 0 <= a && 0 <= b) && (H(c, a, b), b = a = -1, c = 0)
                        }
                    }
                    0 < c && H(c, a, b)
                })()
        ...
        function h() {
            ...
            if (p.subtitles)for (var a = 0; a < p.subtitles.length; a++) {
                var b = p.subtitles[a];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== t) {
                ...
                k.radius && (A = Ia(k.radius, A));
                var B = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ia(k.innerRadius, A) : 0.7 * A, F = Math.min(B / A, (A - 1) / A);
                ...
                this._animator.animate(0,
                    this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        for (b = 0; b < n.length; b++) {
                            ...
                            d > c && za(p.plotArea.ctx, q[b].center, q[b].radius, f, k.type, c, d, k.fillOpacity, q[b].percentInnerRadius);
                            if (e)break
                        }
                        h()
                    },
    ...
    fa.prototype.registerSpace = function (a, c) {
    ...
    fa.prototype.unRegisterSpace = function (a, c) {
        "top" === a ? this._topOccupied -= c.height : "bottom" === a ? this._bottomOccupied -= c.height : "left" === a ? this._leftOccupied -= c.width : "right" === a && (this._rightOccupied -= c.width)
    };
    ...
    M.prototype._getLineWithWidth = function (a, c, b) {
        a = String(a);
    ...
    M.prototype._wrapText = function () {
        var a = new String(ga(String(this.text))), c = [], b = this.ctx.font, d = 0, e = 0;
        for (this.ctx.font = this._getFontString(); 0 < a.length;) {
            ...
            c.push(g);
            var h = e, e = Math.max(e, g.width), d = d + g.height, a = ga(a.slice(g.text.length,
                a.length));
    ...
    ia.prototype.render = function () {
        if (this.text) {
            var a =
                this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = c.x1, d = c.y1, e = 0, f = 0, g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, h, p;
    ...
    S(pa, L);
    pa.prototype.render = ia.prototype.render;
    S(qa, L);
    qa.prototype.render = function () {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = null, d = 0, e = 0, f = 0, g = 0, h = this.chart._options.legend && !x(this.chart._options.legend.markerMargin) ? this.chart._options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var p = [], k = [];
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? X.getDefaultLegendMarker(m.type) : m.markerType, q = m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart._publicChartReference,
                    legend: this._options,
                    dataSeries: m,
                    dataPoint: null
                }) :
                    m.name, r = m.legendMarkerColor ? m.legendMarkerColor : m.markerColor ? m.markerColor : m._colorSet[0], s = m.markerSize || "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type ? 0.75 * this.lineHeight : 0, t = m.legendMarkerBorderColor ? m.legendMarkerBorderColor : m.markerBorderColor, u = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, m.dataPoints[0], m, n), l = {
                    markerType: l,
                    markerColor: r,
                    text: q,
                    textBlock: null,
                ...
                var w = m.dataPoints[v], l = w.legendMarkerType ? w.legendMarkerType : m.legendMarkerType ? m.legendMarkerType : X.getDefaultLegendMarker(m.type), q = w.legendText ? w.legendText : m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart._publicChartReference,
                    legend: this._options,
                    dataSeries: m,
                    dataPoint: w
                ...
                m.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, w, m, v), l = {
                    markerType: l,
                    markerColor: r,
                    text: q,
                    textBlock: null,
        ...
        if (0 < p.length) {
            ...
            for (n = 0; n < p.length; n++) {
                ...
                if (!(0 >= g || "undefined" === typeof g || 0 >= q || "undefined" === typeof q)) {
                    ...
                    } else l.textBlock = new M(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: q,
        ...
        for (n = c = 0; n < k.length; n++) {
            ...
            for (w = v = 0; w < m.items.length; w++) {
                ...
                P.drawMarker(r + s / 2, t + this.lineHeight / 2, this.ctx, l.markerType,
        ...
        0 < p.length && a.layoutManager.registerSpace(b, {width: this.width + 2 + 2, height: this.height + 5 + 5});
        this.bounds =
            {x1: e, y1: d, x2: e + this.width, y2: d + this.height}
    };
    S(va, L);
    ...
    X.prototype.getDataPointAtX = function (a, c) {
        if (!this.dataPoints || 0 === this.dataPoints.length)return null;
        var b = {
            dataPoint: null,
            distance: Infinity,
            index: NaN
        }, d = null, e = 0, f = 0, g = 1, h = Infinity, p = 0, k = 0, n = 0;
        ...
        for (; ;) {
            ...
            if (0 <= f && f < this.dataPoints.length) {
                var d = this.dataPoints[f], m = this.axisX.logarithmic ? d.x > a ? d.x / a : a / d.x : Math.abs(d.x - a);
    ...
    X.prototype.getDataPointAtXY = function (a, c, b) {
        ...
        b = b || !1;
        var d = [], e = 0, f = 0, g = 1, h = !1, p = Infinity, k = 0, n = 0, m = 0;
        ...
        for (; ;) {
            f = 0 < g ? m + e : m - e;
            if (0 <= f && f < this.dataPoints.length) {
                var l = this.chart._eventManager.objectMap[this.dataPointIds[f]], q = this.dataPoints[f], r = null;
                if (l) {
                    switch (this.type) {
                        case "column":
                        case "stackedColumn":
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = R("markerSize", q, this) || 4, t = b ? 20 : s, r = Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - c, 2));
    ...
    X.prototype.getMarkerProperties = function (a, c, b, d) {
        ...
        return {
            ...
            borderThickness: e[a].markerBorderThickness ? e[a].markerBorderThickness : this.markerBorderThickness ? this.markerBorderThickness :
                null
        }
    };
    S(B, L);
    ...
    B.prototype.createLabels =
        function () {
            var a, c, b = 0, d = 0, e, f = 0, g = 0, d = 0, h = this.interval, p = 0, k, n = 0.6 * this.chart.height;
            if ("axisX" !== this.type || "dateTime" !== this.chart.plotInfo.axisXValueType || this.logarithmic) {
                e = this.viewportMaximum;
                if (this.labels) {
                    a = Math.ceil(h);
                    for (var h = Math.ceil(this.intervalStartPosition), m = !1, b = h; b < this.viewportMaximum; b += a)if (this.labels[b]) m = !0; else {
                        m = !1;
                        break
                    }
                ...
                if (this.logarithmic && !this.equidistantInterval) {
                    ...
                    }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : Z(b, this.valueFormatString, this.chart._cultureInfo), a = new M(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        maxHeight: g,
                ...
                for (b = this.intervalStartPosition; b <= e; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase, this.interval) : b + this.interval).toFixed(14)))a = this.labelFormatter ? this.labelFormatter({
                    chart: this.chart._publicChartReference, axis: this._options,
                    value: b, label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : Z(b, this.valueFormatString, this.chart._cultureInfo), a = new M(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: f,
            ...
            } else for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Aa(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < e; Aa(b, h, this.intervalType))a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart._publicChartReference,
                axis: this._options,
                value: b,
                label: this.labels[b] ? this.labels[b] : null
            }) : "axisX" === this.type && this.labels[a] ? this.labels[a] :
                xa(b, this.valueFormatString, this.chart._cultureInfo), a = new M(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: f,
                maxHeight: g,
            ...
            if (this.labelAutoFit || this._options.labelAutoFit)if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)if (f = 0.9 * p >> 0, m = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                for (b = 0; b < this._labels.length; b++) {
                    ...
                    for (var r, s = a.text.split(" "), d = 0; d < s.length; d++)l = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, l = this.ctx.measureText(l), l.width > m && (r = b, m = l.width)
                }
                b = 0;
                for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock,
                ...
                f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth, this.sessionVariables.labelMaxHeight = g, this.sessionVariables.labelWrap = this.labelWrap); else {
                    ...
                    f && d < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, m), this.sessionVariables.labelWrap = !0, x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 3.2 * f && d < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = s,
                        ...
                        c = this._labels[l].textBlock, c.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, m), s), c = c.measureText(), q.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                } else(this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : Math.min((d - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = 0 != this.labelAngle ? (n - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI /
                ...
                0.3 * this.chart.width >> 0 : this._options.labelMaxWidth, g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                this.sessionVariables.labelFontSize = this.labelFontSize;
                ...
                0 !== this._options.labelAngle) ? x(this._options.labelWrap) ? x(this._options.labelWrap) && (x(this._options.labelMaxWidth) ? x(c) || (p = q.height + c.height >> 0, p - 2 * g > m && (m = p - 2 * g, p >= 2 * g && p < 2.4 * g ? (x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = g, this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize) : p >= 2.4 * g && p < 2.8 * g ? (this.sessionVariables.labelMaxHeight =
                    ...
                    this._options.labelMaxWidth ? this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap);
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("left" === this._position || "right" === this._position) t = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight :
                    ...
                    "#EEEEEE" : f._options.labelBackgroundColor;
                a = new M(this.ctx, {
                    x: 0,
                    y: 0,
                    backgroundColor: c,
                    ...
                    fontFamily: "outside" === f.labelPlacement ? f._options.labelFontFamily ?
                        f._options.labelFontFamily : this.labelFontFamily : f.labelFontFamily,
    ...
    B.prototype.createLabelsAndCalculateHeight =
        function () {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                (c = this._stripLineLabels[b].textBlock, d = c.measureText(), e = 0 === this.labelAngle ? d.height : d.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - c.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), a < e && (a = e), this._stripLineLabels[b].effectiveHeight = e)
            }
            return (this.title ? this._titleTextBlock.measureText().height + 2 : 0) + a + this.tickLength + 5
        };
    B.setLayoutAndRender = function (a, c, b, d, e) {
        ...
        var n = c ? c.margin : 0, m = b ? b.margin : 0, l = 0, q = 0, r = 0, s, t, u, v, w, z, B = 0, A = 0, C, D, F;
        C = D = F = !1;
        a && a.title && (a._titleTextBlock = new M(a.ctx, {
            text: a.title,
            horizontalAlign: "center",
        ...
        c && c.title && (c._titleTextBlock = new M(c.ctx, {
            text: c.title,
            horizontalAlign: "center",
        ...
        b && b.title && (b._titleTextBlock = new M(b.ctx, {
            text: b.title,
            horizontalAlign: "center",
        ...
        if ("normal" === d) {
            ...
            c && c.title &&
            (c._titleTextBlock.maxWidth = c.titleMaxWidth || e.height, c._titleTextBlock.maxHeight = c.titleWrap ? 0.8 * e.width : 1.5 * c.titleFontSize, c._titleTextBlock.angle = -90);
            ...
            for (; 4 > l++;) {
                ...
                H.push(s);
                g =
                    Math.round(e.x2 - s - m > a.chart.width - 10 ? a.chart.width - 10 : e.x2 - s - m);
                ...
                0 < A ? f += A : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 === a.labelAngle && (0 < A && (f += A), 0 < B && (g -= B)));
                ...
                G.push(t);
                a._labels && 1 < a._labels.length && (d = h = 0, h = a._labels[1], d = "dateTime" === a.chart.plotInfo.axisXValueType ? a._labels[a._labels.length -
                ...
                b && (f = Math.round(a.lineCoordinates.x2),
                    d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(f + s), h = Math.round(e.y2 - t - a.margin), b.lineCoordinates = {
                    x1: f,
                    y1: d,
                    x2: f,
                    y2: h,
                ...
                a._labels && 1 < a._labels.length && (w = (a.logarithmic ? Math.log(a._labels[1].position / a.viewportMinimum) / a.conversionParameters.lnLogarithmBase :
                ...
                a._labels[a._labels.length - 1].position - a.viewportMinimum) * Math.abs(a.conversionParameters.pixelPerUnit) + a.lineCoordinates.x1);
                c && c.calculateValueToPixelConversionParameters();
                b && b.calculateValueToPixelConversionParameters();
                if (a || c || b) {
                    if (!x(G))for (l = 0; l < G.length; l++)for (j = l + 1; j < G.length; j++)G[l] == G[j] && (C = !0);
                    if (!x(E))for (l = 0; l < E.length; l++)for (j = l + 1; j < E.length; j++)E[l] == E[j] && (D = !0);
                    if (!x(H))for (l = 0; l < H.length; l++)for (j = l + 1; j < H.length; j++)H[l] == H[j] && (F = !0)
                }
                if (C && D && F)break
            }
            k.save();
            ...
            for (; 4 > l++;) {
                ...
                m.push(B);
                c && (c.lineCoordinates = {}, f = Math.round(e.x1 + B + a.margin), g = Math.round(e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2), c.labelAutoFit && !x(s) && (f = 0 > c.labelAngle ? Math.max(f, s) : 0 === c.labelAngle ? Math.max(f, s / 2) : f, g = 0 < c.labelAngle ? g - t : 0 === c.labelAngle ?
                g - t / 2 : g), c.lineCoordinates.x1 = f, c.lineCoordinates.x2 = g, c.lineCoordinates.width = Math.abs(g - f), c.title && (c._titleTextBlock.maxWidth = 0 < c.titleMaxWidth && c.titleMaxWidth < c.lineCoordinates.width ? c.titleMaxWidth : c.lineCoordinates.width));
                b && (b.lineCoordinates = {}, f = Math.round(e.x1 + B + a.margin), g = Math.round(e.x2 > b.chart.width - 10 ? b.chart.width - 10 : e.x2), c && c.labelAutoFit && !x(u) && (f = 0 < b.labelAngle ? Math.max(f, u) : 0 === b.labelAngle ? Math.max(f, u / 2) : f, g -= v / 2), b.lineCoordinates.x1 = f, b.lineCoordinates.x2 = g, b.lineCoordinates.width =
                ...
                w.push(A);
                z.push(q);
                c && 0 < c._labels.length && (h = c._labels[0], d = c._labels[c._labels.length - 1], s = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                    t = d.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(d.textBlock.angle)) + (d.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(d.textBlock.angle)));
                ...
                p.panEnabled ? A = p.sessionVariables.axisY.height : p.sessionVariables.axisY.height = A;
                ...
                b && (d = Math.round(e.y1 + b.margin),
                    h = e.y1 + b.margin + q, b.lineCoordinates.y1 = h, b.lineCoordinates.y2 = h, b.boundingRect = {
                    x1: f,
                    y1: d,
                    x2: g,
                    y2: h,
                ...
                c && c.labelAutoFit && (g = 0 > c.labelAngle ? Math.max(g,
                    s) : 0 === c.labelAngle ? Math.max(g, s / 2) : g, f = 0 > c.labelAngle || 0 === c.labelAngle ? g - B : f);
                b && b.labelAutoFit && (g = b.lineCoordinates.x1, f = g - B);
        ...
        if ("undefined" === typeof this._options.interval) {
            if ("bottom" === this._position || "top" === this._position)if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, f, g = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), p = this._labels.length - 1; 0 <= p; p--) {
                    ...
                    n.position > this.viewportMaximum || !(p ===
                    this._labels.length - 1 || f < Math.log(g / n.position) * h / d) || (c.push(n), g = n.position, f = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                }
                this._labels = c
            } else {
            ...
            if ("left" === this._position || "right" === this._position)if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var c = [], k, g = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), p = this._labels.length - 1; 0 <= p; p--) {
                    n = this._labels[p];
                    if (n.position < this.viewportMinimum)break;
                    n.position > this.viewportMaximum || !(p === this._labels.length - 1 || k < Math.log(g / n.position) * h) || (c.push(n), g = n.position, k = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width *
                        Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                }
                this._labels = c
            } else {
                for (p = 0; p < this._labels.length; p++)n = this._labels[p], n.position < this.viewportMinimum || (n = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += n);
                b > this.lineCoordinates.height * d && this.labelAutoFit && (a = !0)
            }
        }
        if ("bottom" === this._position) {
            for (var n, p = 0; p < this._labels.length; p++)n = this._labels[p], n.position < this.viewportMinimum || n.position > this.viewportMaximum ||
            (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== e++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, d = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(d, b.y << 0), this.ctx.lineTo(d, b.y + this.tickLength << 0), this.ctx.stroke()), 0 === n.textBlock.angle ? (b.x -= n.textBlock.width / 2, b.y += this.tickLength + n.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) :
                0, b.y += this.tickLength + Math.abs(0 > this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), n.textBlock.x = b.x, n.textBlock.y = b.y, n.textBlock.render(!0)));
            ...
            2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength), n.textBlock.render(!0)));
            ...
            for (p = 0; p < this._labels.length; p++)n = this._labels[p], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position),
            ...
            this.labelAngle ? b.x + (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : b.x + this.tickLength + 5), n.textBlock.render(!0)));
    ...
    B.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var c = this, b, d = 0, e = 0, f = !1, g = !1, h = [], p = [],
                     g = !1, d = 0; d < this.stripLines.length; d++) {
                var k = this.stripLines[d];
                k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum) || h.push(k))
            }
            for (d = 0; d < this._stripLineLabels.length; d++)if (k = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum)) {
                a = this.getPixelCoordinatesOnAxis(b.position);
                if ("outside" === b.stripLine.labelPlacement)if (k && (this.ctx.strokeStyle = k.color, "pixel" === k._thicknessType && (this.ctx.lineWidth =
                        k.thickness)), "bottom" === this._position) {
            ...
            if (!g) {
                ...
                this.ctx.clip();
                for (d = 0; d < h.length; d++)k = h[d], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    this.ctx.save();
                    this.ctx.beginPath();
                    this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                    this.ctx.clip();
                    for (e =
                             0; e < h.length; e++)k = h[e], k.showOnTop && k.render();
                    this.ctx.restore()
                }, k)) : k.render();
                for (d = 0; d < p.length; d++)b = p[d], b.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    for (e = 0; e < p.length; e++)b = p[e], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (c.ctx.save(), c.ctx.beginPath(), c.ctx.rect(c.chart.plotArea.x1, c.chart.plotArea.y1, c.chart.plotArea.width, c.chart.plotArea.height), c.ctx.clip(), b.textBlock.render(!0), c.ctx.restore())
                }, b.textBlock)) :
                "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
                this.ctx.restore();
                g = !0
            }
            if (g)for (g = !1, d = 0; d < p.length; d++)b = p[d], b.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                for (e = 0; e < p.length; e++)b = p[e], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0)
    ...
    B.prototype.renderAxisLine = function () {
        ...
        } else"left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(D(this.lineDashType,
    ...
    B.prototype.convertPixelToValue = function (a) {
        ...
        return c = this.logarithmic ? Math.pow(this.logarithmBase, (a - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit) * this.viewportMinimum : this.conversionParameters.minimum + (a - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit
    };
    ...
    B.prototype.calculateValueToPixelConversionParameters = function (a) {
        ...
        if ("bottom" ===
            this._position || "top" === this._position) this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? -1 : 1) * c * a.lnLogarithmBase / Math.log(Math.abs(this.range))) : a.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(this.range), a.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
        if ("left" === this._position || "right" === this._position) this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? 1 : -1) * b * a.lnLogarithmBase / Math.log(Math.abs(this.range))) :
            a.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(this.range), a.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
        this.conversionParameters = a
    };
    B.prototype.convertValueToPixel = function (a) {
        return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase + 0.5 << 0 : this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) +
        0.5 << 0
    };
    B.prototype.calculateAxisParameters = function () {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters(); else {
            ...
            "axisX" === this.type && (b = 100 > this.maxWidth ? 3 :
                300 > this.maxWidth ? 6 : 600 > this.maxWidth ? 8 : 6);
            var a = Math.max(b, Math.floor(this.maxWidth / a)), d, e, f, b = 0;
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
            if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
            "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 0 === e - d && (b = "undefined" === typeof this._options.interval ?
                ...
                0), 0 === d && 0 === e ? (e += 9, d = 0) : 0 === e - d ? (b = Math.min(Math.abs(0.01 * Math.abs(e)), 5), e += b, d -= b) : d > e ? (b = Math.min(Math.abs(0.01 * Math.abs(e - d)), 5), 0 <= e ? d = e - b : e = d + b) : (b = Math.min(Math.abs(0.01 * Math.abs(e - d)), 0.05), 0 !== e && (e += b), 0 !== d && (d -= b)), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < d && (d = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > e && (e = 0));
            b = (isNaN(this.viewportMaximum) ||
            ...
            if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType =
                ...
                if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = e + f / 2;
                ...
                this.interval = this._options && 0 < this._options.interval ? this._options.interval : B.getNiceNumber(b /
                    (a - 1), !0);
                ...
                if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = "axisX" === this.type ? e + f / 2 : Math.ceil(e / this.interval) * this.interval;
            ...
            if (null === this.minimum || null === this.maximum)if ("axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === e - d && (b = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval, e += b, d -= b), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1) : "axisY" === this.type && (d = null !==
                ...
                Math.abs(e - d) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < d && (d = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > e && (e = 0)), "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                if (null === this.minimum || isNaN(this.minimum)) this.minimum = d - f / 2;
                if (null === this.maximum || isNaN(this.maximum)) this.maximum = e + f / 2
            } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? d - f / 2 : Math.floor(d / this.interval) * this.interval, this.minimum =
            ...
            if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.range)) {
                ...
                if (2 < c)for (d = 0; d < c - 2; d++)this.valueFormatString += "#"
            }
        }
    };
    B.prototype.calculateLogarithamicAxisParameters = function () {
        ...
        "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width);
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth / 100)) : Math.max(Math.floor(this.maxWidth / 50), 3), d, e, f, g;
        g = 1;
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
        "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
        ...
        e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 1 < d && (d = 1), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 1 > e && (e = 1));
        g = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) / (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? d : this.viewportMinimum);
        linearRange = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) - (isNaN(this.viewportMinimum) ||
            null === this.viewportMinimum ? d : this.viewportMinimum);
        this.intervalType = "number";
        g = Math.pow(this.logarithmBase, B.getNiceNumber(Math.abs(Math.log(g) / c), !1));
        this._options && 0 < this._options.interval ? this.interval = this._options.interval : (this.interval = B.getNiceExponent(Math.log(g) / c / (a - 1), !0), b = B.getNiceNumber(linearRange / (a - 1), !0));
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? d / Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(d) /
                c / this.interval));
        ...
        1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this._options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this._options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase), this._options && "undefined" === typeof this._options.interval &&
        (this.interval = B.getNiceExponent(Math.ceil(Math.log(g) / c) / (a - 1)), b = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        if (null === this.minimum || null === this.maximum) "axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / d && (g = Math.pow(this.logarithmBase, "undefined" === typeof this._options.interval ? 0.4 : this._options.interval), e *= g, d /= g), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / d > this.logarithmBase ?
    ...
    B.getNiceExponent = function (a, c) {
        var b = Math.floor(Math.log(a) / Math.LN10), d = a /
            Math.pow(10, b), d = 0 > b ? 1 >= d ? 1 : 5 >= d ? 5 : 10 : Math.max(Math.floor(d), 1);
    ...
    B.prototype.getLabelStartPoint = function () {
        ...
        if ("millisecond" !== this.intervalType)if ("second" === this.intervalType) 0 <
        a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0)); else if ("minute" === this.intervalType) {
    ...
    ra.prototype.render = function () {
        this.ctx.save();
        var a = this.parent.getPixelCoordinatesOnAxis(this.value), c = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit *
        this.thickness);
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, h = this.chart.plotArea.y2; else if ("left" === this.parent._position || "right" === this.parent._position) g =
                h = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2;
            this.ctx.moveTo(e, g);
            this.ctx.lineTo(f, h);
            this.ctx.stroke();
    ...
    U.prototype._initialize = function () {
        if (this.enabled) {
            ...
            a += t ? "background: rgba(255,255,255,.9);" :
    ...
    U.prototype._updateToolTip = function (a, c) {
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                f = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX.convertPixelToValue({y: c}) : this.chart.axisX.convertPixelToValue({x: a});
                d = [];
                ...
                f = d[0];
                for (b = 0; b < d.length; b++)d[b].dataPoint.x.valueOf() ===
                f.dataPoint.x.valueOf() && e.push(d[b]);
                d = null
            } else {
                if (g = this.chart.getDataPointAtXY(a, c, !0)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index; else if (t)if (g = Ea(a, c, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    g = {};
                    if (0 <= this.currentDataPointIndex) b = d.dataPoints[this.currentDataPointIndex], g.dataSeries = d, g.dataPoint = b, g.index = this.currentDataPointIndex, g.distance = Math.abs(b.x - f); else {
                        if (!this.enabled || "line" !== d.type && "stepLine" !== d.type && "spline" !== d.type && "area" !== d.type && "stepArea" !== d.type && "splineArea" !== d.type && "stackedArea" !== d.type && "stackedArea100" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !==
                            d.type && "candlestick" !== d.type && "ohlc" !== d.type)return;
                    ...
                    } else"column" === d.type || "bar" === d.type ? 0 >
                    ...
                    g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum) && e.push(g); else e.push(g)
                }
            }
            if (0 < e.length && (this.highlightObjects(e), this.enabled))if (f = "", f = this.getToolTipInnerHTML({entries: e}), null !== f) {
                ...
                "pie" ===
                e[0].dataSeries.type || "doughnut" === e[0].dataSeries.type || "funnel" === e[0].dataSeries.type || "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? g = a - 10 - this.container.clientWidth : (g = e[0].dataSeries.axisX.convertValueToPixel(e[0].dataPoint.x) - this.container.clientWidth << 0, g -= 10);
                0 > g && (g += this.container.clientWidth + 20);
                g + this.container.clientWidth > Math.max(this.chart._container.clientWidth, this.chart.width) && (g = Math.max(0,
                    Math.max(this.chart._container.clientWidth, this.chart.width) - this.container.clientWidth));
                g += "px";
                e = 1 !== e.length || this.shared || "line" !== e[0].dataSeries.type && "stepLine" !== e[0].dataSeries.type && "spline" !== e[0].dataSeries.type && "area" !== e[0].dataSeries.type && "stepArea" !== e[0].dataSeries.type && "splineArea" !== e[0].dataSeries.type ? "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? e[0].dataSeries.axisX.convertValueToPixel(e[0].dataPoint.x) :
                    c : e[0].dataSeries.axisY.convertValueToPixel(e[0].dataPoint.y);
                e = -e + 10;
    ...
    U.prototype.highlightObjects = function (a) {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                !1 === f.highlightEnabled || !0 !== d.highlightEnabled && !0 !== f.highlightEnabled || ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type ||
                "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type ? (f = d.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), P.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = d.getMarkerProperties(g, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF",
                    ...
                    "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), c.globalAlpha = 1) : "ohlc" === d.type && (c.globalAlpha = 1, c.strokeStyle = e.color, c.lineWidth = 2 * e.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(e.x3 - d, e.y2), c.lineTo(e.x3 - d, e.y3), c.stroke(), c.beginPath(), c.moveTo(e.x3, e.y1), c.lineTo(e.x1, e.y1), c.stroke(), c.beginPath(), c.moveTo(e.x3, e.y4), c.lineTo(e.x2, e.y4), c.stroke(), c.globalAlpha = 1))
            }
        }
        c.restore();
        c.globalAlpha = 1;
    ...
    U.prototype.getToolTipInnerHTML = function (a) {
        a = a.entries;
        for (var c = null, b = null, d = null, e = 0, f = "", g = !0, h = 0; h < a.length; h++)if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) {
            g = !1;
            break
        }
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
            ...
            for (var p = "", h = 0; h < a.length; h++)if (b = a[h].dataSeries, d = a[h].dataPoint, e = a[h].index,
                    f = "", 0 === h && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, b, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== b._options.toolTipContent)) {
                ...
                (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"; else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type) f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"; else if ("candlestick" === b.type || "ohlc" === b.type) f += d.toolTipContent ?
                    d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
                null === c && (c = "");
            ...
            if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type) f =
    ...
    z.prototype.getPercentAndTotal = function (a, c) {
        ...
        if (0 <= a.type.indexOf("stacked")) d = 0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals &&
        (d = a.plotUnit.yTotals[b], e = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    z.prototype.replaceKeywordsWithValue = function (a, c, b, d, e) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var g = "#percent", h = "#total", p = this.getPercentAndTotal(b,
                c), h = isNaN(p.total) ? h : p.total, g = isNaN(p.percent) ? g : p.percent;
            do {
                p = "";
                if (b.percentFormatString) p = b.percentFormatString; else {
                    var p = "#,##0.", k = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2);
                    if (isNaN(k) || !isFinite(k)) k = 2;
                    for (var n = 0; n < k; n++)p += "#"
                }
                a = a.replace("#percent", Z(g, p, f._cultureInfo));
                a = a.replace("#total", Z(h, b.yValueFormatString ? b.yValueFormatString : "#,##0.########"))
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            try {
                var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                h && 0 < h.length && (g = ga(h[2]), a = ga(h[1]))
            } catch (k) {
            }
            h = null;
            ...
            h = h[a];
            null !== g && (h = h[g]);
            return "x" === a ? !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic &&
            ("dateTime" === f.plotInfo.axisXValueType || "dateTime" === b.xValueType || c.x && c.x.getTime) ? xa(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo) : Z(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : "#,##0.########", f._cultureInfo) : "y" === a ? Z(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : "#,##0.########",
                f._cultureInfo) : "z" === a ? Z(h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : "#,##0.########", f._cultureInfo) : h
        })
    };
    ...
    ha.prototype.mouseEventHandler =
        function (a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                    ...
                    d.eventContext = {
                        context: f, userContext: f, mouseover: "mouseover",
                ...
                } else"legendItem" === d.objectType && (e = this.chart.data[d.dataSeriesIndex], f = null !== d.dataPointIndex ? e.dataPoints[d.dataPointIndex] :
                    null, d.eventParameter = {
                    x: b.x,
                    y: b.y,
                    dataSeries: e._options,
                    dataPoint: f,
                ...
                for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
                    ...
                    f ?
                        this.fireEvent(this.mouseoveredObjectMaps[b], "mouseout", a) : e.push(this.mouseoveredObjectMaps[b])
                }
    ...
    ha.prototype.fireEvent = function (a, c, b) {
        if (a && c) {
            var d =
    ...
    S(ja, L);
    wa.prototype.animate = function (a, c, b, d, e) {
        var f = this;
        ...
        for (a = []; 0 < this.animations.length;)if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = e(Math.min(b - c.startTime, c.duration), 0, 1, c.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) && (d = 1), 1 > d && a.push(c), c.animationCallback(d), 1 <= d && c.onComplete) c.onComplete();
        this.animations = a;
    ...
    wa.prototype.cancelAllAnimations = function () {
        this.animations = [];
    ...
    var F = {
        yScaleAnimation: function (a, c) {
            if (0 !== a) {
                ...
                b.drawImage(d, 0, 0, d.width, d.height, 0, e - e * a, b.canvas.width / O, a * b.canvas.height / O)
            }
        }, xScaleAnimation: function (a,
                                      c) {
            if (0 !== a) {
                var b = c.dest, d = c.source.canvas, e = c.animationBase;
                b.drawImage(d, 0, 0, d.width, d.height, e - e * a, 0, a * b.canvas.width / O, b.canvas.height / O)
            }
        }, xClipAnimation: function (a, c) {
            if (0 !== a) {
                var b = c.dest, d = c.source.canvas;
                b.save();
                0 < a && b.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / O, d.height / O);
                b.restore()
            }
            ...
            if (0 !== a) {
                ...
                b.save();
                b.globalAlpha = a;
                b.drawImage(d, 0, 0, d.width, d.height, 0, 0, b.canvas.width / O, b.canvas.height / O);
                b.restore()
            }
        }, easing: {
            linear: function (a,
        ...
        drawMarker: function (a, c, b, d, e, f, g, h) {
            if (b) {
                ...
                b.lineWidth = h ? h : 0;
                "circle" === d ? (b.moveTo(a, c), b.beginPath(), b.arc(a, c, e / 2, 0, 2 * Math.PI, !1), f && b.fill(), h && (g ? b.stroke() : (p = b.globalAlpha, b.globalAlpha =
                    ...
                    e / 4, b.beginPath(), b.moveTo(a - e / 2, c - e / 2), b.lineTo(a + e / 2, c + e / 2), b.stroke(), b.moveTo(a + e / 2, c - e / 2), b.lineTo(a - e / 2, c + e / 2), b.stroke())
            }
        ...
        Chart: function (a, c) {
            ...
            b =
                b || "en";
            if (ka[b])return Z(a, c || "#,##0.##", new ja(b));
            throw"Unknown Culture Name";
        }, formatDate: function (a, c, b) {
            b = b || "en";
            if (ka[b])return xa(a, c || "DD MMM YYYY", new ja(b));
            throw"Unknown Culture Name";
        }
    };
    Ja.Chart.version = "v1.9.1 GA";
    window.CanvasJS = Ja
})();
/*
